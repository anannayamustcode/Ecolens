...
const BACKEND_NGROK_URL = process.env.BACKEND_NGROK_URL || " https://f56b41f2b38c.ngrok-free.app";
...
app.post('/api/test-ml-connection', async (req, res) => {
  try {
    ...
    const testPayload = {
      image_path1: "https://f56b41f2b38c.ngrok-free.app/uploads/back-test.jpg",
      image_path2: "https://f56b41f2b38c.ngrok-free.app/uploads/front-test.jpg"
    };
