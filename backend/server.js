...
const BACKEND_NGROK_URL = process.env.BACKEND_NGROK_URL || "https://7dcdf2a69ac9.ngrok-free.app";
const ML_NGROK_URL = process.env.ML_NGROK_URL || "https://21f00540a87b.ngrok-free.app";
...
app.post('/api/test-ml-connection', async (req, res) => {
  try {
    ...
    const testPayload = {
      image_path1: "https://7dcdf2a69ac9.ngrok-free.app/uploads/back-test.jpg",
      image_path2: "https://7dcdf2a69ac9.ngrok-free.app/uploads/front-test.jpg"
    };
