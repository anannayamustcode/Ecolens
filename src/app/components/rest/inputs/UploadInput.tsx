...
export default function UploadInput({ onComplete }: UploadInputProps) {
  ...
  const packagingOptions = [
    "Plastic Bottle", "Glass Bottle", "Plastic Tube", "Metal Can", "Flexible Pouch",
    "Pump Dispenser Bottle", "Spray Bottle", "Solid Stick Container", "Single-use Sachet",
    "Tetra Pak Carton", "Dropper Bottle", "Blister Pack (Pills/Tablets)", "Cardboard Box",
    "Metal Tin", "Roll-on Applicator", "Foam Dispenser", "Glass Ampoule", "Medical Vial",
    "Plastic Canister", "Refill Cartridge"
  ];
      ...
      {activeSide ? (
        ...
        <>
          ...
          <div className="w-full mb-4 text-gray-500">
            <label htmlFor="packaging-select" className="block text-sm font-medium text-gray-700 mb-1">
            ...
            >
              <option 
              value="" disabled>Select an option</option>
